...
useEffect(() => {
  ...
  if (tab && ["profile", "notifications", "payout"].includes(tab)) {
    setActiveTab(tab);
  }
}, [searchParams]);
...
<>
  ...
  <div className="space-y-3 mb-6">
    ...
    <p className="text-md text-gray-600 dark:text-gray-300 ">
      Hotelire uses an enterprise-grade secure payment platform, <span className="font-semibold">Stripe</span>, to
      handle all payouts. To receive payments from customers, you must connect your Stripe account below.
    </p>

    <p className="text-md text-gray-800 dark:text-gray-500 ">
      Hotelire does <span className="font-semibold">not</span> process or hold customer payments. You receive
      exactly what customers pay, directly into your connected Stripe account.
    </p>
  </div>
