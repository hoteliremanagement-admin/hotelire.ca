...
// //             // Create subscription
// //             const response = await fetch(`${baseUrl}/stripes/create-subscription`, {
// //                 method: "POST",
// //                 credentials: "include",
...
// //             console.log("CLIENT SECRET RECEIVED FRONTEND:", data?.clientSecret);
...
// //             // ensure we HAVE a client secret before confirming
...
// //     if (loading) {
// //         return <div className="p-6 text-gray-500">Loading subscription status...</div>;
// //     }

// //     return (
// //         <div className="space-y-6">
// //             <div className="border-b pb-4">
// //                 <h3 className="text-lg font-semibold text-gray-800 mb-2">Monthly Subscription</h3>
// //                 <p className="text-sm text-gray-600">
// //                     Subscribe to enable property listings. CAD $10/month charged on the 10th.
// //                 </p>
// //             </div>
...
// //                         ❌ <strong>Subscription Payment Overdue:</strong> Your properties have been disabled due to failed payment.
// //                         Please update your payment method immediately to reactivate your listings.
// //                     </AlertDescription>
// //                 </Alert>
// //             )}
...
// //                         ⚠️ <strong>Payment Failed:</strong> {subscription.daysSinceFailed} days since first failure.
// //                         Update payment method or properties will be disabled after 20 days.
// //                     </AlertDescription>
// //                 </Alert>
// //             )}
...
// //                             <div>
// //                                 <h4 className="font-semibold text-gray-800">Active Subscription</h4>
// //                                 <p className="text-sm text-gray-600">CAD $10/month</p>
// //                             </div>
// //                         </div>
// //                         <span
...
// //                                 <span className="font-medium text-red-600">{subscription.consecutiveFailures}</span>
// //                             </div>
// //                         )}
// //                     </div>
...
// //                             className="w-full bg-[#59A5B2] hover:bg-[#4a9199] flex items-center justify-center gap-2"
// //                         >
// //                             <CreditCard className="w-4 h-4" />
// //                             {isSubscribing ? "Processing..." : "Subscribe - CAD $10/month"}
// //                         </Button>
...
//             //     `${baseUrl}/stripes/getSubscriptionClientSecret/${data.subscriptionId}`,
//             //     { credentials: "include" }
//             // );

//             // const data2 = await res2.json();

//             // console.log("CLIENT SECRET FETCH RESULT", data2);
...
//             // const ClientScretresponse = await fetch(`${baseUrl}/stripes/getSubscriptionClientSecret/${subscriptionId}`, {
//             //     method: "GET",
//             //     credentials: "include",
//             //     headers: { "Content-Type": "application/json" }
...
//             // console.log("ClientScretresponse", ClientScretresponse)
